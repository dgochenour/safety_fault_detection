...
DDS_Long sleep_time, DDS_Long count)
{
    ...
    *DDS_StringSeq_get_reference(&dp_qos.discovery.initial_peers,0) = DDS_String_dup(peer);
    ...
    /* DPSE requires the remote participant name to be set.
    * The remote_participant_name argument is available for your convenience in case you want
    * to use DPSE instead of DPDE.
    */
