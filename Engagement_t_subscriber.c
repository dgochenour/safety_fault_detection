...
*/
void
control_EngagementSubscriber_deserialize_unsigned_long(char **src_buffer,
    ...
    DDS_Boolean *dropped)
{
    ...
    * function and control_EngagementSubscriber_deserialize_unsigned_long
    * to match your type.
    */
    control_EngagementSubscriber_deserialize_unsigned_long(&src_buffer,
    need_byte_swap,
    (DDS_UnsignedLong*)&id);
...
/*i
* \brief Helper function to filter an control_Engagement sample
*
* \param[in]  sample       A control_Engagement data sample to filter
* \param[out] drop_sample  Out parameter determining whether the sample
*                          should be filtered out or not.
*/
void 
control_EngagementSubscriber_filter_sample(control_Engagement *sample,
...
*/
DDS_Boolean
control_EngagementSubscriber_on_before_sample_commit(
    void *listener_data,
    DDS_DataReader *reader,
    ...
    DDS_Boolean *dropped)
{
    control_Engagement *hw_sample = (control_Engagement *)sample; 

    control_EngagementSubscriber_filter_sample(hw_sample, dropped);
...
DDS_Long sleep_time, DDS_Long count)
{
    ...
    */
    ...
    dr_listener.on_data_available = control_EngagementSubscriber_on_data_available;
