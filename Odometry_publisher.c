...
void
nav_msgs_msg_OdometryPublisher_on_publication_matched(void *listener_data,
...
DDS_Long sleep_time, DDS_Long count)
{
    ...
    nav_msgs_msg_OdometryDataWriter *hw_datawriter;
    ...
    sample = nav_msgs_msg_Odometry_create();
    if (sample == NULL)
    {
        printf("failed nav_msgs_msg_Odometry_create\n");
        return 0;
    }
    ...
    */
    ...
    nav_msgs_msg_OdometryPublisher_on_publication_matched;
    datawriter =
    ...
    hw_datawriter = nav_msgs_msg_OdometryDataWriter_narrow(datawriter);
    ...
    (application->count == 0); ++i)
    {
        ...
        retcode = nav_msgs_msg_OdometryDataWriter_write(hw_datawriter, sample, &DDS_HANDLE_NIL);
        if (retcode != DDS_RETCODE_OK)
        {
    ...
    if (sample != NULL)
    {
        nav_msgs_msg_Odometry_delete(sample);
    }
