...
int subscriber_main_w_args(
    ...
    /* DataReaders */
    DDS_DataReader *steering_cmd_topic_dr = NULL;
    /* DataReader QoS */
    struct DDS_DataReaderQos steering_cmd_topic_dr_qos = 
            DDS_DataReaderQos_INITIALIZER;
    /* DataReader Listeners */          
    struct DDS_DataReaderListener steering_cmd_topic_dr_listener = 
            DDS_DataReaderListener_INITIALIZER;
    /* remote publication discovery information (required for DPSE) */         
    struct DDS_PublicationBuiltinTopicData steering_cmd_topic_pub_data =
    ...
    *DDS_StringSeq_get_reference(&dp_qos.discovery.initial_peers,0) = 
    ...
    strcpy(dp_qos.participant_name.name, LATERAL_SYSTEM_PARTICIPANT_NAME);
    ...
    /* steering_cmd_topic DataReader */
    steering_cmd_topic_dr_qos.protocol.rtps_object_id = 
            STEERING_CMD_TOPIC_DR_RTPS_OBJ_ID;
    steering_cmd_topic_dr_qos.resource_limits.max_instances = 2;
    steering_cmd_topic_dr_qos.resource_limits.max_samples_per_instance = 32;
    steering_cmd_topic_dr_qos.resource_limits.max_samples = 
            steering_cmd_topic_dr_qos.resource_limits.max_instances *
            steering_cmd_topic_dr_qos.resource_limits.max_samples_per_instance;
    steering_cmd_topic_dr_qos.reader_resource_limits.max_remote_writers = 10;
    steering_cmd_topic_dr_qos.reader_resource_limits.max_remote_writers_per_instance = 10;
    steering_cmd_topic_dr_qos.history.depth = 32;
    steering_cmd_topic_dr_qos.reliability.kind = DDS_RELIABLE_RELIABILITY_QOS;

    /* assign steering_cmd_topic DataReader callbacks */
    steering_cmd_topic_dr_listener.on_data_available = 
            steering_cmd_topic_dr_on_data_available;
    steering_cmd_topic_dr_listener.on_subscription_matched =
            steering_cmd_topic_dr_on_subscription_matched;

    steering_cmd_topic_dr = DDS_Subscriber_create_datareader(
            subscriber,
            DDS_Topic_as_topicdescription(steering_cmd_topic), 
            &steering_cmd_topic_dr_qos,
            &steering_cmd_topic_dr_listener,
            DDS_DATA_AVAILABLE_STATUS | DDS_SUBSCRIPTION_MATCHED_STATUS);
    if(steering_cmd_topic_dr == NULL) {
     ...
     * DataWriter
     */
    steering_cmd_topic_pub_data.key.value[DDS_BUILTIN_TOPIC_KEY_OBJECT_ID] = 
            STEERING_CMD_TOPIC_DW_RTPS_OBJ_ID;
    steering_cmd_topic_pub_data.topic_name = 
            DDS_String_dup(control_STEERING_CMD_TOPIC_NAME);
    steering_cmd_topic_pub_data.type_name = 
            DDS_String_dup(control_ANGLE_TYPE_NAME);
    steering_cmd_topic_pub_data.reliability.kind = DDS_RELIABLE_RELIABILITY_QOS;
    retcode = DPSE_RemotePublication_assert(
            dp,
            MOTION_CONTROLLER_PARTICIPANT_NAME,
            &steering_cmd_topic_pub_data,
